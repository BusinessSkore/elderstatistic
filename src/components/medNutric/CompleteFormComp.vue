<template>
  ...
  <!-- {{ this.historicoEvaluaciones.length }} -->
  <div>
    <div>
      <Navbar />
      <Transition>
      ...
      <div v-if="showModalAseguradoras" class="modal7">
        <div class="contenedor7">
          ...
          <label @click="this.showModalAseguradorasMethod()">X</label>
            ...
            <div class="contenido7">
              ...
              <div>
                <table id="customers">
                  ...
                  >
                    <td>{{ index + 1 }}</td>
                    <td>{{ this.formatDateRead(evaluacion.fecha) }}</td>
                    <td>{{ evaluacion.fuerza }}</td>
          ...
          <fieldset>
            ...
            <div class="grid">
              ...
              <div>
                ...
                <div v-show="!showModalAseguradoras">
                  <button
                    @click.prevent="this.loadHistorial()"
            ...
            <div class="grid">
              ...
              <button
                ...
                "
                class="btn btn-success"
                @click.prevent="goToEval(this.evaluacion)"
              >
                <i class="fas fa-edit"></i> Ver Hoja de Verificación
              </button>
              ...
              <button
                v-if="
                  this.evaluacion.status !== '3' && this.estaMatrizEgresoData
                "
                @click.prevent="this.setAltaMedica()"
...
export default defineComponent({
  ...
  methods: {
    ...
    setAltaMedica() {
      if (
        confirm(
          `¿ESTÁ SEGURO QUE DESEA DAR DE ALTA A ESTE PACIENTE CON ${this.evaluacion.cantidadEvaluaciones} EVALUACIONES?`
        )
      ) {
        this.evaluacion.status = "3";
    ...
    async loadHistorial() {
      ...
      this.historicoEvaluaciones = patientData.data.Items;
    ...
    async createEvaluacion() {
      if (
        ...
        this.evaluacion.id_centerKit =
          this.evaluacion.id_centerKit + "-" + this.evaluacion.kit;
        try {
